...
void generate(const int n, const int m, std::function<void(std::array<int, NUM_TIDS>&)> func)
{
  static std::array<int, NUM_TIDS> hand;
...
int main()
{
  ...
  generate(0, NUM_TILES, [&calsht, &num_hands](std::array<int, NUM_TIDS>& hand) {
